                    ...
                    <table class="w-full text-left border-collapse min-w-[1400px]">
                        <thead>
                            <tr class="bg-[var(--brand-green)] text-white text-[12px] font-black uppercase">
                                ...
                                <th colspan="5" class="px-4 py-3 border-r border-white/10 text-center">
                                    Type de carton
                                </th>
                                
                                <th rowspan="2" class="px-4 py-3 border-r border-white/10 text-center">Début de triage</th>
                                <th rowspan="2" class="px-4 py-3 border-r border-white/10 text-center">Fin de triage</th>
                                
                                <th colspan="14" class="px-4 py-2 text-center border-b border-white/10 bg-black/10">
                                    N° du tapis utilisé
                                </th>
                                
                                <th rowspan="2" class="px-4 py-3 border-l border-white/10 text-center">Nombre de carton</th>
                                <th rowspan="2" class="px-4 py-3 text-center">Qualité de Soufrage</th>
                                
                            </tr>

                            <tr class="bg-[var(--brand-green)] text-[10px] font-black">
                                <th colspan="5" class="border-r border-white/10 h-full"></th>
                                
                                <th 
                                    v-for="n in 14" 
                                    :key="n" 
                                    class="px-1 py-2 text-center border-r border-white/10 w-10 text-[var(--brand-orange)] bg-[var(--brand-green)]/10"
                                >
                                    T{{ n }}
                                </th>
                            </tr>
                        ...
                        <tbody class="divide-y divide-[var(--sidebar-border)]">
                            <tr v-for="(row, index) in rows" :key="row.id" 
                                class="hover:bg-[var(--brand-green)]/5 transition-colors tr-row"> 
                                ...
                                <td class="px-4 py-4 sticky left-0 bg-[var(--card)] z-10 border-r border-[var(--sidebar-border)]">
                                    <input v-model="row.code" type="text" class="input-line">
                                </td>
                                ...
                                <td class="px-2 py-4 border-l border-[var(--sidebar-border)]">
                                    <input v-model="row.nombre" type="number" class="input-line">
                                </td>
