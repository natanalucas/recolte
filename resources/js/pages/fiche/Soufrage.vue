...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Fiche de Soufrage', href: '/fiche-soufrage' },
    { title: 'Fiche Traçabilité', href: '/fiche-tracabilite' },
    { title: 'Fiche de Soufrage', href: '/fiche-soufrage' },
    { title: 'Fiche Traçabilité', href: '/fiche-tracabilite' },
    { title: 'Fiche de Soufrage', href: '/fiche-soufrage' }
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 transition-colors bg-[var(--background)] text-[var(--text)] font-sans">
            ...
            />
            <div class="flex justify-between items-center py-4 text-sm font-medium">
                <div class="bg-[var(--card)] border border-[var(--sidebar-border)] rounded-xl p-5 shadow-sm max-w-lg">
                    <div class="space-y-3">
                        <div class="flex items-baseline gap-3">
                            <span class="text-[13px] uppercase tracking-wider font-bold w-33 shrink-0">
                                Produit traité :
                            </span>
                        ...
                        <div class="flex items-baseline gap-3">
                            ...
                            <p class="text-[12px] font-medium italic flex-1">
                                Conservation du litchi frais
                            </p>
                        </div>
                    </div>
                </div>
